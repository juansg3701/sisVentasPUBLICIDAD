	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<body>
				...
				{!!Form::open(array('url'=>'almacen/cliente2','method'=>'POST','autocomplete'=>'off'))!!}
			    {{Form::token()}}
			...
			{!!Form::close()!!}	
			<a href="{{URL::action('ClienteController@index',0)}}">
						<button class="btn btn-info" >Ver clientes</button></a>	
			</body>
		</div>	
		</div>
	</div>
