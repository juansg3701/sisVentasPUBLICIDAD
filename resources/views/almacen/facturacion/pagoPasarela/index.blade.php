...
<body>
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
			<h3>Pago de de la compra: {{$id}}</h3>
				...
				<?php 
								...
								//$api_key="70Uqr3qWLpK4MT710BsDV2ld9c";
								  $monto=round($f->pago_total,0); 
								  $mercid="508029";
								  //$mercid="833866";
								  $referenceCode='F'.$f->id_factura.$f->cliente_id_cliente.rand(1000,5000);
			...
			<a href="{{URL::action('facturacionListaVentas@show',0)}}"><button class="btn btn-danger" >Volver</button></a>
			</div>
