...
<body>
	...
	{!!Form::model($stock,['method'=>'PATCH','route'=>['almacen.pedidosDevoluciones.devolucionIgual.update',$stock->id_stock]])!!}
    {{Form::token()}}
	...
	<div id=formulario>
			...
			<a href="{{url('almacen/pedidosDevoluciones/devolucionIgual')}}" class="btn btn-danger">Volver</a>
			</div>
	</div>
