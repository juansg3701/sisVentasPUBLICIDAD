...
<body>
	...
	{!!Form::open(array('url'=>'almacen/facturacion/listaPedidosUnoa','method'=>'POST','autocomplete'=>'off'))!!}
    {{Form::token()}}
	...
	<div class="row" align="center">	
		<div class="col-sm-12" align="center">
			<div class="card" align="center">
				...
				<div class="row" align="center">
					<div class="col-sm-12" align="center">
						<br><h1 class="h3 mb-2 text-gray-800">REGISTRAR PEDIDO UNOA</h1><br>
					</div>
				</div>
				                ...
				                <div class="card-body card-block" align="center">
									...
									<div class="form-row">
										<div class="form-group col-sm-12">
											<button class="btn btn-info" type="submit">Registrar</button>
											<a href="{{URL::action('facturacionListaPedidosUnoa@index',0)}}" class="btn btn-danger">Regresar</a>
										</div>
									</div>
				               </div>
				        	</div>
