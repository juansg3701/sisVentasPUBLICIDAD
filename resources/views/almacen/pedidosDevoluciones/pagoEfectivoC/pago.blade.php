...
role="dialog" tabindex="-1" id="modal-pagarC-{{$apc->id_abono}}">
	...
	<div class="modal-dialog">
		...
		{!!Form::model($a,['method'=>'PATCH','route'=>['almacen.pedidosDevoluciones.pagoEfectivoC.update',$apc->id_abono]])!!}
	 {{Form::token()}}
	 <div class="col-md-12">
		 <div id=formulario>
	 ...
	 {!!Form::close()!!}
	 		...
	 		<div class="col-md-6">
				...
				<a href="{{URL::action('pagoAClienteController@show',$apc->id_abono)}}"><button class="btn btn-info">Continuar</button></a>	
	 		</div>
				 </div>
