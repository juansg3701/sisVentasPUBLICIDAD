...
class AbonoCartera extends Controller
{
	  public function __construct(){
	 	...
	 	public function index(Request $request){
	 		if ($request) {
	 			...
	 			return view('almacen.facturacion.ventasProductos.productos',["searchText"=>$query, "modulos"=>$modulos,"productos"=>$productos,"productosEAN"=>$productosEAN, "id"=>$id,"descuentos"=>$descuentos, "productoGeneral"=>$productoGeneral,"impuestos"=>$impuestos,"facturas"=>$facturas]);
	 		}
	 	}
