...
class facturacionFListaVentas extends Controller
{
	...
	public function edit($id){
			...
			$modulos=DB::table('cargo_modulo')
	 		...
	 		return view('almacen.facturacion.FacturaVenta.index',["id"=>$id,"modulos"=>$modulos,"datos"=>$datos, "productos"=>$productos, "nomEmpleado"=>$nomEmpleado, "nomCliente"=>$nomCliente, "impuestos"=>$impuestos, "descuentos"=>$descuentos]);
 	}
