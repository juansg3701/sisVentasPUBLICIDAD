		...
		$this->middleware('auth');	
	 	...
	 	public function index(Request $request){
	 		...
	 		if ($request) {
	 			...
	 			->select('tc.id_remision','tc.noproductos','tc.fecha_solicitud','tc.fecha_entrega','tc.pago_inicial','tc.porcentaje_venta','tc.pago_total', 'e.nombre as empleado', 'c.nombre as cliente', 'p.nombre as tipo_pago', 'tc.estado', 'tc.fecha_aprobacion','tc.observacion')
