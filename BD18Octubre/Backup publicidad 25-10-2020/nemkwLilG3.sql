...
--
-- Servidor: localhost
-- Tiempo de generación: 21-10-2020 a las 16:57:52
...
(1, 'juan12', 'juan@gmail.com', 1, 1, '31289362', 'calle 12', '193648', 9, '0000-00-00', ''),
(29, 'Juliana12', '', 1, 1, '131231', 'calle 12', '089231980', 20, '2020-10-18', '1231234');
...
(7, '1', '1', 'a', 1, 2, '2020-03-01', '1.jpeg', 1, 0, 0),
(8, '788', '99', 'qq', 123, 1, NULL, '3.2.jpeg', 1, 0, 0);
...
CREATE TABLE `stock` (
  ...
  `disponibilidad` char(1) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `producto_id_producto` int(11) NOT NULL,
  `sede_id_sede` int(11) NOT NULL,
...
(9, 'juan12', 'juan@gmail.com', '$2y$10$MdSnZTIALoa1ZRG.8GUwfeljEf6UT0OA5pTFYaSyE3UV7c3iXRx3K', '18YNxhwj227P3b131UoARL3oZw4yGg7CbrTKAkNKt0BOhcJvXSDEowJtooJM', '2019-11-06 11:38:48', '2020-10-18 22:31:53', 1, 1, 1),
(20, 'Juliana', 'jualiana@gmail.com', '$2y$10$Ufrdm5A4ZWQMTpaDnPn5AuruPHfsH/fjXXIY9O0TFjY1JwtrostMm', NULL, '2020-10-19 00:56:07', '2020-10-19 00:56:07', 1, 1, 0);
...
--
ALTER TABLE `cargo_modulo`
  MODIFY `id_cargoModulo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
